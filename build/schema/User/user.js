...
module.exports = {
  ...
  Mutation: {
    ...
    addUser: async (_, args, {
      ...
      const isExistEmail = await prisma.$exists.user({
        email
      });
      ...
      const isExistNickname = await prisma.$exists.user({
        nickname
      });
    ...
    updateUser: async (_, args, {
      ...
      const isExistUser = await prisma.$exists.user({
        id
      });
  ...
  MessageRoom: {
    // 최근 내 메세지
    recentMyMessage: async (parent, _, {
      request,
      prisma
    }) => {
      const {
