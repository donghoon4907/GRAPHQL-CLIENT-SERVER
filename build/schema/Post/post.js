  ...
  Mutation: {
    ...
    confirmAccept: async (_, args, {
      ...
      if (accept) {
        ...
        const postRoom = await prisma.post({
          id: postId
        }).room();
